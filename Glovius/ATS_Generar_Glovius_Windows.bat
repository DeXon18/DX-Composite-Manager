...
TITLE ATS DX Glovius Host ID Generator
...
set "PS_SCRIPT=%WINDOWS_DIR%\obtener_glovius.ps1"
...
if not exist "%PS_SCRIPT%" (
    ...
    echo ATS_Generar_Glovius_Windows.bat
    echo Windows\obtener_glovius.ps1
    echo.
    pause
    exit /b 1
)
